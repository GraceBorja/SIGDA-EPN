...
public class LoginV extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtUsuario.getText().equals("GRACE") && String.valueOf(txtPassword.getPassword()).equals("1234")){
            JOptionPane.showMessageDialog(null,"BIENVENID@ AL SISTEMA DE GESTIÓN DE ARCHIVOS Y DOCUMENTOS DE LA EPN");
        }else{
...
//        JOptionPane.showMessageDialog(null, String.valueOf(txtPassword.getPassword()));
